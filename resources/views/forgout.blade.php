                ...
                <div class="row justify-content-center">
                    <div class="col-md-12 col-lg-10">
                        ...
                        <div class="wrap d-md-flex">
                            <div class="img" style="background-image: url({{ asset('assets/login-form/images/background-login.jpg') }});"></div>
                            ...
                            <div class="login-wrap p-4 p-md-5">
                                ...
                                @else
                                    <form action="{{ route('send-code-password') }}" method="POST" class="signin-form">
                                        ...
                                        <div class="form-group">
                                            <button type="submit" class="form-control btn btn-danger rounded submit px-3">Solicitar código</button>
                                        </div>
                                    </form>
                                @endif
