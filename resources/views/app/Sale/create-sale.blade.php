        ...
        <div class="card">
            <div class="card-body m-0 p-3">
                ...
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    ...
                    {{-- <li class="nav-item" role="presentation">
                        <button class="nav-link" id="lote-tab" data-bs-toggle="tab" data-bs-target="#lote-justified" type="button" role="tab" aria-controls="lote" aria-selected="false" tabindex="-1">Enviar Direto (Lote)</button>
                    </li> --}}
                </ul>
                ...
                <div class="tab-content pt-2" id="myTabjustifiedContent">
                    ...
                    <div class="tab-pane fade" id="association-justified" role="tabpanel" aria-labelledby="association-tab">
                        <div class="row">
                            ...
                            <div class="modal fade" id="filterModal" tabindex="-1">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <form action="{{ route('create-sale', ['product' => $product->id, 'tab' => 'association-justified']) }}" method="GET">
                            ...
                            <div class="modal fade" id="addModal" tabindex="-1">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <form action="{{ route('created-sale-association', ['product' => $product->id, 'tab' => 'association-justified']) }}" method="POST" enctype="multipart/form-data">
                                            @csrf
                                            <div class="modal-header">
                            ...
                            <div class="text-center">
                                {{ $salesType3->appends(request()->query())->links() }}
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="tab-pane fade" id="lote-justified" role="tabpanel" aria-labelledby="lote-tab">
                        <div class="row">
                            ...
                            <div class="text-center">
                                {{ $salesType2->appends(request()->query())->links() }}
                            </div>
                        </div>
                    </div>
                </div>
