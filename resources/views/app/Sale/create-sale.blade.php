            ...
            <div class="card-body m-0 p-3">
                ...
                <div class="tab-content pt-2" id="myTabjustifiedContent">
                    <div class="tab-pane fade active show" id="profile-justified" role="tabpanel" aria-labelledby="profile-tab">
                        <form action="{{ route('created-client-sale') }}" method="POST" class="row">
                            @csrf
                            <div class="col-12 col-sm-12 col-md-5 col-lg-5 row">
                                <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                                    <p class="card-title">Dados do Cliente</p>
                                </div>
                                ...
                                <div class="col-12 col-sm-12 offset-md-6 col-md-6 offset-lg-6 col-lg-6 mb-2">
                                    <div class="d-grid">
                                        <button type="submit" class="btn btn-outline-primary mt-1">Avançar</button>
                                    </div>
                                </div>
                            </div>
                        </form>

                        <form action="{{ route('created-sale') }}" method="POST" id="formSale" class="row d-none g-3">
                            @csrf
                                ...
                                <div class="col-12 col-sm-12 col-md-6 col-lg-5 card">
                                    <div class="row">
                                        ...
                                        <div class="col-12 mb-2 mt-2 btn-group">
                                            <a href="{{ route('create-sale', ['product' => $product->id]) }}" title="Recarregar" class="btn btn-outline-primary"><i class="bi bi-arrow-counterclockwise"></i></a>
